import { c as W, g as J, j as o, r as b, L as K } from './app-CZKEO1x-.js';
var k = { exports: {} },
    X = k.exports,
    G;
function V() {
            ...
            (function (y, p) {
                (function (m, u) {
                    ...
                    function (m) {
                        ...
                        var h = !!/Mobi/.test(navigator.userAgent),
                            g =
                        ...
                        return (
                                ...
                                return {
                                    ...
                                    reset: function () {
                                        clearTimeout(d.time.TIMER),
                                            ...
                                            t.setSetting(r, 'time', d.time),
                                            n.classList.add(i + '-reseted'),
                                            n.classList.remove(i + '-paused'),
                                            s !== null &&
                                                ((s.style.transition = 'none'),
                                                (s.style.width = '100%')),
                                            typeof e == 'function' &&
                                ...
                                (n.parentNode.style.height = d + 'px'),
                                    ...
                                    (!h || window.innerWidth > O) &&
                                        (n.parentNode.style.transitionDelay =
                                            '0.2s');
                                try {
                                    var s = new CustomEvent(i + '-closing', {
                                        detail: r,
                                        bubbles: !0,
                                        cancelable: !0,
                                    });
                            ...
                            (u.show = function (a) {
                                ...
                                (function () {
                                    e.inputs.length > 0 &&
                                        (t.inputs.classList.add(i + '-inputs'),
...
It can be › ` +
                                ...
                                try {
                                    var d = new CustomEvent(i + '-opening', {
                                        detail: e,
                                        bubbles: !0,
                                        cancelable: !0,
                                    });
                                ...
                                setTimeout(function () {
                                    t.toast.classList.remove(i + '-opening'),
                                        t.toast.classList.add(i + '-opened');
                                    try {
                                        var s = new CustomEvent(i + '-opened', {
                                            detail: e,
                                            bubbles: !0,
                                            cancelable: !0,
                                        });
...
const P = J(Z),
                            ...
                            o.jsxs('div', {
                                children: [
                                    ...
                                    o.jsx('select', {
                                        ...
                                        className:
                                            'w-full p-2 border border-gray-300 rounded-lg bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent',
                                        children: Object.values(i).map((g, j) =>
                                            o.jsx(
                                                'option',
                                                {
                                                    value: g.id,
        ...
        o.jsxs('div', {
            ...
            children: [
                ...
                o.jsx('div', {
                    ...
                    children: Object.values(y).map((u) =>
                        o.jsxs(
                            'div',
                            {
                                className:
    ...
    ee = ({ householdByIncome: y, totalIncomeItem: p }) =>
        o.jsxs('div', {
            className: 'bg-white p-6 rounded-lg shadow-md',
            children: [
                o.jsx('h2', {
                ...
                o.jsx('div', {
                    className: 'divide-y divide-gray-200',
                    children: Object.values(y).map((m) =>
                        o.jsxs(
                            'div',
                            {
                                className:
    ...
    te = ({ year: y, month: p, setYear: m, setMonth: u }) => {
        const [i, h] = b.useState(new Date(y, p - 1, 1));
        b.useEffect(() => {
            h(new Date(y, p - 1, 1));
        }, [y, p]);
        const g = () => {
                const x = new Date(i.getFullYear(), i.getMonth() - 1, 1);
                h(x);
                const C = x.getFullYear(),
                    I = x.getMonth() + 1;
                m(C),
                    u(I),
                    (window.location.href = `/dashboard?year=${C}&month=${I}`);
            },
            j = () => {
                const x = new Date(i.getFullYear(), i.getMonth() + 1, 1);
                h(x);
        ...
        return o.jsxs('div', {
            ...
            children: [
                ...
                o.jsxs('span', {
                    ...
                    children: [i.getFullYear(), '年 ', i.getMonth() + 1, '月'],
                }),
                o.jsx('button', {
                    onClick: j,
                    className:
    ...
    ne = ({ householdItems: y, year: p, month: m, setYear: u, setMonth: i }) =>
        o.jsx('div', {
            className:
                'overflow-x-auto bg-white h-full rounded-lg shadow-md p-6',
            children: o.jsxs('div', {
                className: 'lg:min-w-[600px] divide-y divide-gray-200',
                children: [
                    o.jsxs('div', {
                        className:
                            'flex gap-x-4 py-2 font-medium text-gray-500 border-b',
                        children: [
                            o.jsx('span', {
                                className: 'lg:w-[5rem]',
                                children: '日付',
                  ...
                  ${g.payment_type.is_credit_card ? 'bg-sky-100' : ''}`,
                                    children: [
                                        ...
                                        o.jsx('p', {
                                            className:
                                                'lg:w-[10rem] text-gray-800',
                                            children: g.category.name,
                                        }),
                                        o.jsx('p', {
                                            className:
                                                'lg:w-[10rem] text-gray-800',
                                            children: g.payment_type.name,
                                        }),
                                        o.jsxs('p', {
                                            className:
                                                'lg:w-[10rem] text-gray-800 font-semibold',
                                            children: [
                                                '¥',
                                        ...
                                        o.jsx('p', {
                                            className:
                                                'w-full lg:w-min lg:flex-1 text-gray-800 text-sm',
                                            children: g.memo,
                                        }),
                                    ],
                                },
    ...
    oe = ({
        ...
        householdByIncome: x = [],
        creditCardExpenditure: C = 0,
        totalExpenditure: I = 0,
        totalIncome: O = 0,
    }) => {
        const [T, z] = b.useState(p),
            [D, v] = b.useState(m),
            [w, B] = b.useState(g),
            [R, A] = b.useState(u),
            [F, S] = b.useState(j),
            ...
            [c, f] = b.useState(() => {
                const L = new Date(),
                    E =
                        parseInt(L.getUTCFullYear()) === parseInt(p) &&
                        parseInt(L.getUTCMonth() + 1) === parseInt(m)
                            ? new Date(Date.UTC(p, m - 1, L.getUTCDate()))
            ...
            q = (L) => {
                const M = L.target.value,
                    E = h.find((N) => N.id === Number(M));
                E != null && E.is_income ? A(i) : A(u), U(L);
            };
        b.useEffect(() => {
            _({ ...H, category_id: Object.keys(R)[0] });
        }, [R]);
        const [H, _] = b.useState({
                date: c,
                category_id: Object.keys(R)[0],
                payment_type_id: h.length > 0 ? h[0].id : '',
                amount: 1e3,
                memo: '',
                year: T,
                month: D,
            ...
            Y = async (L) => {
                ...
                try {
                    const M = document
                        ...
                        N = await E.json();
                    if (!E.ok) throw new Error(N.message);
                    B(N.households),
                        S(N.householdByExpenditure),
                        n(N.householdByIncome),
                        t(N.creditCardExpenditure),
                        d(N.totalExpenditure),
                        l(N.totalIncome),
                        P.success({
                            title: 'Success',
                            message: N.message,
