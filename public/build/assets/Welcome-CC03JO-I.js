import { j as e, L as d, $ as s } from './app-BmYrGWcD.js';
function x({ auth: l, laravelVersion: n, phpVersion: o }) {
    const c = () => {
        var a, r, t, i;
        (a = document.getElementById('screenshot-container')) == null ||
            a.classList.add('!hidden'),
            (r = document.getElementById('docs-card')) == null ||
                r.classList.add('!row-span-1'),
            (t = document.getElementById('docs-card-content')) == null ||
                t.classList.add('!flex-row'),
            (i = document.getElementById('background')) == null ||
                i.classList.add('!hidden');
    };
    return e.jsxs(e.Fragment, {
        children: [
            e.jsx(d, { title: 'Welcome' }),
            e.jsxs('div', {
                className:
                ...
                children: [
                    ...
                    e.jsx('div', {
                        ...
                        children: e.jsxs('div', {
                            className:
                                'relative w-full max-w-2xl px-6 lg:max-w-7xl',
                            children: [
                                e.jsxs('header', {
                                    className:
                                    ...
                                    children: [
                                        e.jsx('div', {
                                            className:
                                                'flex lg:col-start-2 lg:justify-center',
                                            children: e.jsx('svg', {
                                                className:
                                                    ...
                                                    e.jsxs('div', {
                                                        ...
                                                        children: [
                                                            e.jsxs('div', {
                                                                ...
                                                                className:
                                                                    'flex items-start gap-6 lg:flex-col',
                                                                children: [
                                                                    e.jsx(
                                                                        'div',
                                                                        {
